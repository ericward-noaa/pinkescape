...
Instead of the defaults, we can create a dataframe with custom parameters and pass these in. The default parameters can be found using the `ricker_defaults()` function,  

```{r}
pars <- ricker_defaults()
```
